...
class Ui_instanceSettingsWidget(object):
    def setupUi(self, instanceSettingsWidget):
        ...
        instanceSettingsWidget.resize(650, 312)
        instanceSettingsWidget.setMinimumSize(QtCore.QSize(650, 312))
        instanceSettingsWidget.setMaximumSize(QtCore.QSize(650, 312))
        self.groupBox_2 = QtWidgets.QGroupBox(instanceSettingsWidget)
        self.groupBox_2.setGeometry(QtCore.QRect(190, 40, 211, 161))
        self.groupBox_2.setObjectName("groupBox_2")
        self.apiIdEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.apiIdEdit.setGeometry(QtCore.QRect(10, 40, 191, 20))
        self.apiIdEdit.setObjectName("apiIdEdit")
        self.apiHashEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.apiHashEdit.setGeometry(QtCore.QRect(10, 80, 191, 20))
        self.apiHashEdit.setObjectName("apiHashEdit")
        self.ownerIdEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.ownerIdEdit.setGeometry(QtCore.QRect(10, 120, 191, 20))
        ...
        self.runInstanceButton.setGeometry(QtCore.QRect(430, 220, 191, 31))
        ...
        self.groupBox.setGeometry(QtCore.QRect(420, 40, 211, 161))
        self.groupBox.setObjectName("groupBox")
        self.loggingLevelCB = QtWidgets.QComboBox(self.groupBox)
        self.loggingLevelCB.setGeometry(QtCore.QRect(10, 80, 191, 22))
        ...
        self.consoleLoggingLevelCB.setGeometry(QtCore.QRect(10, 120, 191, 22))
        ...
        self.enablePLAutoUpdateChB.setGeometry(QtCore.QRect(10, 40, 191, 20))
        ...
        self.removeInstanceButton.setGeometry(QtCore.QRect(200, 270, 191, 31))
        ...
        self.instancesList.setGeometry(QtCore.QRect(0, 0, 171, 311))
        ...
        self.newInstanceButton.setGeometry(QtCore.QRect(200, 220, 191, 31))
        ...
        self.saveSettingsButton.setGeometry(QtCore.QRect(430, 270, 191, 31))
    ...
    def retranslateUi(self, instanceSettingsWidget):
        ...
        self.saveSettingsButton.setText(_translate("instanceSettingsWidget", "Advanced"))
